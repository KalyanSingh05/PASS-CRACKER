...
class PyCrack:
    ...
    def my_start(self):
        main.clear()
        print(self.intro)
        print(f"{self.blue}Select {self.red}[1]{self.blue} Dictionay {self.red}[2]{self.blue} Random {self.red}[3]{self.blue} Identify-Hash {self.red}[0]{self.blue} Exit")
        ...
        #=================================================================================================================================================================================================================================== 
            ...
            b_commands = input(f"{self.bright}{self.red}Pass{self.green}@{self.red}Cracker/Dictionay~#{self.reset_all} ")
            if b_commands == "1":
                ...
                hash_type = input(f"{self.red}Select [1]MD5 [2]SHA1 [3]SHA224 [4]SHA256 [5]SHA384 [6]SHA512 Type >>{self.reset_all}")
                b_dic = input(f"{self.red}Input Dictionay File Path or Name >>{self.reset_all}")
                start_time = time.time()
                for i in self.gen.Dictionay(b_dic):
                    main.trying(i,start_time)
        ...
        #===================================================================================================================================================================================================================================
            ...
            hash = input(f"{self.bright}{self.red}Pass{self.green}@{self.red}Cracker/Hash-Identifier~#{self.reset_all}")
            if len(hash) == 32:
                print(f"{self.bright}{self.green}Hash Function : MD5{self.reset_all}")
                exit()

            elif len(hash) == 40:
                print(f"{self.bright}{self.green}Hash Function : SHA-1{self.reset_all}")
                exit()

            elif len(hash) == 64:
                print(f"{self.bright}{self.green}Hash Function : SHA-256{self.reset_all}")
                exit()

            elif len(hash) == 96:
                print(f"{self.bright}{self.green}Hash Function : SHA-384{self.reset_all}")
                exit()

            elif len(hash) == 128:
                print(f"{self.bright}{self.green}Hash Function : SHA-512{self.reset_all}")
                exit()

            else:
                print(f"{self.bright}{self.red}This hash type is not supported.{self.reset_all}")
                quit()
